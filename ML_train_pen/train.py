...
mapped_read_counts = ['pen_introgression_counts.csv']
genomes = ['Spenn.fasta']
gene_models = ['spenn_v2.0_gene_models_annot.gff']
num_chromosomes = [['Spenn-ch01', 'Spenn-ch02', 'Spenn-ch03', 'Spenn-ch04', 'Spenn-ch05',
