...
source_path = "/nam-99/ablage/nam/adejoro_folder/filtered_feature_counts_pen/filtered_counts_only_folder"
dest_path = "/nam-99/ablage/nam/adejoro_folder/filtered_counts_matrix_pen"
...
output_path = os.path.join(dest_path, "filtered_counts_matrix_pen.csv")
